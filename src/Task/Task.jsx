...
const App = () => {
  ...
  const TransactionChart = () => {
    ...
    return (
      <div className='chart'>
        <h2 className='mb-4 mt-4 text-center'>{selectedCustomer.name}'s Transactions</h2>
        <Bar data={chartData} />
      </div>
    );
  };
  ...
  return (
    <div>
      ...
      <h3 className='mt-4 mb-4 link-danger text-center'> <span className='fa-solid fa-arrow-down-long'></span> Click on customers to view the chart <span className='fa-solid fa-arrow-down-long'></span></h3>
